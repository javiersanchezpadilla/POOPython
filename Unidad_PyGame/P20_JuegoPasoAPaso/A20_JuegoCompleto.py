...
ruta_icono = 'alienicono.png'
icono = pygame.image.load('alienicono.png')
pygame.display.set_icon(icono)


# P12 Agregar la música de fondo
# -------------------------------
ruta_musica_fondo = 'MusicaFondo.mp3'
ruta_disparo = 'disparo.mp3'
ruta_colision = 'Golpe.mp3'
