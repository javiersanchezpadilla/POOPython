""" MANEJO DE TERMINACION DEL JUEGO (GAME OVER).

    GAME OVER Es cuando los enemigos alcanzan y destruyen al heroe, esto es,
            que hayan alcanzado la altura donde esta nuestra nave
            checamos la altura de la nave > 500
"""
import pygame
import random
import math
...
# Subimos la musica de fondo del juego y hacemos que suene
mixer.music.load('MusicaFondo.mp3')
# podemos controlar el volumen con valores entre 0 y 1
mixer.music.set_volume(0.5)
# La opcion (-1) es para que cuando termine comience de nuevo
mixer.music.play(-1)
...
# declaramos el tipo de fuente a usar en la pantalla grafica 
# si descargamos otra fuente aqui podemos cambiarla 
fuente = pygame.font.Font('freesansbold.ttf', 32)
texto_x = 10
texto_y = 10

# 2) variables para el manejo del mensaje de JUEGO TERMINADO /////////////////////////////////
# creacion de la variable para el fin del juego
...
# 3) FUNCION PARA EL MANEJO DEL FINAL DEL JUEGO //////////////////////////////////////////////
# Funcion texto para el final del juego
def texto_final():
...
while se_ejecuta:
    ...
    for e in range(cantidad_enemigos):
        ...
        # 1) VALIDAMOS LA ALTURA DE CADA NAVE ENEMIGO //////////////////////////////////////////
        #    en esta parte se valida si u enemigo alanzo la altura de la nave
        #    lo cual nos indica que ya perdimos.
        if malote_y[e] > 500:
            for k in range(cantidad_enemigos):
                malote_y[k] = 1000  # para sacarlo visualmente de la pantalla
            texto_final()           # vamos a crear esta funcion del GAME OVER!!!!
            break
        ...
        if colision:                            # Si hay colision se debe:
            # Sonido para el manejo de la colision de la bala con el enemigo
    ...
    # Llamar a la funcion para cargar nuestra nave o heroe
    jugador(jugador_x, jugador_y)


    # Llamar ala funcion para el puntaje
