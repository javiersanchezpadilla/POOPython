""" MANEJO DE SONIDOS.
    ...
    Ahora vamos a agregar musica y sonidos de los efectos del juego
    DEntro del proyecto agregamos los archivos de audio con extension MP3
    importamos la libreria mixer desde pygame
    Agregamos sonido de fondo
    sonido para el disparo (desde la barra espaciadora)
    Sonido para cuando la bala toca a un enemigo
"""
import pygame
import random
import math

# 1) IMPORTAMOS LA LIBRERIA PARA MANEJO DEL SONIDO /////////////////////////////////////////
...
# 2) Subimos la musica de fondo del juego y hacemos que suene ///////////////////////////////
mixer.music.load('MusicaFondo.mp3')
# podemos controlar el volumen con valores entre 0 y 1
mixer.music.set_volume(0.5)
# *1 es para que cuando termine comience de nuevo
mixer.music.play(-1)
...
while se_ejecuta:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_SPACE:
                # 3) preparamos el sonido para el disparo //////////////////////////////////////////
    ...
    for e in range(cantidad_enemigos):
        ...
        if colision:                            # Si hay colision se debe:
            ...
            # 4) Sonido para el manejo de la colision de la bala con el enemigo ////////////////////////////
