""" Ejemplo del riesgo de mutabildiad con un diccionario
    ...
    En este ejemplo se esperaria que al recorrer el diccionario se eliminaran
    ...
    LA solución para corregir este error es el uso de CLONACIÓN, el cual se vera
    mas adelante como siguiente tema (ver código B06_Clonacion02.py).
"""
